...
func Test_GenerateCA(t *testing.T) {
	...
	caCertPEM, caKeyPEM, err := GenerateCA(hostname)
...
func Test_GenerateClient(t *testing.T) {
	...
	clientCertPEM, clientKeyPEM, err := GenerateClient(hostname, caCertPEM, caKeyPEM)
...
func Test_CertificateValidity(t *testing.T) {
	...
	clientCertPEM, _, err := GenerateClient(hostname, caCertPEM, caKeyPEM)
	assert.NoError(t, err, "generate client cert should not error")
